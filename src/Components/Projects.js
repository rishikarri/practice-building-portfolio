				...
				<div className='row kill-margin'>
					...
					<div className='col-xs-5 col-xs-offset-1'>
						...
						<div className='section-heading'>
							...
							<p>Monsters are about to attack your village. Please fight them off as long as you can in order to give the villagers time to escape! Be careful! If your health falls to 0 you must retreat!</p>
